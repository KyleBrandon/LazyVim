return {
    ...
    init = function()
        ...
        keys[#keys + 1] = { "gd", "<cmd>Lspsaga peek_definition<CR>", desc = "See definition and make edits in window" }
        ...
        keys[#keys + 1] = { "<leader>D", "<cmd>Lspsaga show_line_diagnostics<CR>", desc = "Show  diagnostics for line" }
        keys[#keys + 1] =
        ...
        keys[#keys + 1] = { "]d", "<cmd>Lspsaga diagnostic_jump_next<CR>", desc = "Jump to next diagnostic in buffer" }
        keys[#keys + 1] = { "K", "<cmd>Lspsaga hover_doc<CR>", desc = "Show documentation for what is under cursor" }
